...
else if(($amt) > $sql1['currentBalance'])
{
        ...
        $sql=mysqli_query($con,"insert into `transaction`(`tid`,`senderName`,`recipientName`,`senderAccountNum`,`recipientAccountNum`,`amount`)values('','".$sname."','".$rname."','".$sacc."','".$racc."','".$amt."') ")or die (mysqli_error($con));
